...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6a728c862eb984f95312abed75eadff4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Implementation of global alignment algorithms for general arrays";
          description = None;
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "globalalignment"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\156\192}\210\026\172\215\130\158+\228\169t\162\240\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
